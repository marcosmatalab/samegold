...
|---|---|---|---|
| ✅ | Fast lane, no JVM and no credentials | <!--sg:SG-00.artifact.tests_passed-->758<!--/sg--> tests pass in <!--sg:SG-00.artifact.fast_lane_seconds-->79.3<!--/sg--> s | `SG-00` |
...
| 🔗 | Evidence records verified in the hash chain | <!--sg:SG-06.artifact.records_verified-->18<!--/sg--> | `SG-06` |
...
| 📉 | Cut in the share of the table a sku query reads, from clustering | <!--sg:SG-09.artifact.share_read_reduction_pct-->78.24<!--/sg-->% | `SG-09` |
