...
make fast      # the whole fast lane: <!--sg:SG-00.artifact.tests_fast-->555<!--/sg--> tests in <!--sg:SG-00.artifact.fast_lane_seconds-->51.3<!--/sg--> s
...
> <!--sg:SG-04.artifact.worst_move_pct-->5.4654<!--/sg-->% of the figure that had been signed off.
...
- deleting one month copied
  **<!--sg:SG-09.artifact.rows_copied_per_row_deleted-->10.95<!--/sg--> surviving rows per deleted
...
| lane | status |
|---|---|
| fast lane: generator, reference, digests, invariants, mutation, governance, evidence gate | done, <!--sg:SG-00.artifact.tests_fast-->555<!--/sg--> tests, <!--sg:SG-00.artifact.fast_lane_seconds-->51.3<!--/sg--> s |
