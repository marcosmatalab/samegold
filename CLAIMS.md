...
the fast lane is <!--sg:SG-00.artifact.line_coverage_pct-->68.31<!--/sg-->%
(<!--sg:SG-00.provenance-->local run, not reproduced in CI, 60656e0f1<!--/sg-->)**, and it is gated at 58 in CI.
...
<!--sg:SG-04.artifact.worst_move_pct-->6.1714<!--/sg-->%.
...
beside it as
<!--sg:SG-04.artifact.worst_move_pct_including_boundary_fixtures-->6.0539<!--/sg-->%, so the size
...
must be read by <!--sg:SG-09.artifact.share_read_reduction_pct-->78.23<!--/sg-->%. The headline is
