...
Result: <!--sg:SG-03.rate-->52/67 (95% CI 66.3%-85.9%)<!--/sg--> of the scored mutants killed; strict score
<!--sg:SG-03.artifact.strict_score-->0.5532<!--/sg--> if the equivalence classification is refused
wholesale.
...
<!--sg:SG-04.artifact.worst_move_pct-->6.4809<!--/sg-->%.
...
after it and is therefore not in this number. Result: <!--sg:SG-06.rate-->81/81 (95% CI 95.5%-100.0%)<!--/sg-->.
