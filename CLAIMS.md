...
<!--sg:SG-00.artifact.tests_fast-->674<!--/sg--> tests, **<!--sg:SG-00.artifact.fast_lane_repository_tests-->499<!--/sg--> of them check the
...
the fast lane is <!--sg:SG-00.artifact.line_coverage_pct-->67.92<!--/sg-->%
(<!--sg:SG-00.provenance-->local run, not reproduced in CI, 5708423a5<!--/sg-->)**, and it is gated at 58 in CI.
...
the ledger, key by key, in cents. Result: <!--sg:SG-01.rate-->9/9 (95% CI 70.1%-100.0%)<!--/sg-->.
...
Result: <!--sg:SG-04.rate-->1/1 (95% CI 20.7%-100.0%)<!--/sg--> of closed months moved, worst
<!--sg:SG-04.artifact.worst_move_pct-->2.9018<!--/sg-->%.
...
beside it as
<!--sg:SG-04.artifact.worst_move_pct_including_boundary_fixtures-->2.6657<!--/sg-->%, so the size
...
after it and is therefore not in this number. Result: <!--sg:SG-06.rate-->203/203 (95% CI 98.1%-100.0%)<!--/sg-->.
