...
<!--sg:SG-00.artifact.tests_fast-->743<!--/sg--> tests, **<!--sg:SG-00.artifact.fast_lane_repository_tests-->568<!--/sg--> of them check the
...
the fast lane is <!--sg:SG-00.artifact.line_coverage_pct-->70.2<!--/sg-->%
(<!--sg:SG-00.provenance-->[CI, 294833ab6](https://github.com/marcosmatalab/samegold/actions/runs/35760498591)<!--/sg-->)**, and it is gated at 58 in CI.
...
<!--sg:SG-04.artifact.worst_move_pct-->5.0973<!--/sg-->%.
...
beside it as
<!--sg:SG-04.artifact.worst_move_pct_including_boundary_fixtures-->5.0016<!--/sg-->%, so the size
...
after it and is therefore not in this number. Result: <!--sg:SG-06.rate-->241/241 (95% CI 98.4%-100.0%)<!--/sg-->.
