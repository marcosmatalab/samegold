...
- deleting one month copied
  **<!--sg:SG-09.artifact.rows_copied_per_row_deleted-->10.97<!--/sg--> surviving rows per deleted
...
| lane | status |
|---|---|
| fast lane: generator, reference, digests, invariants, mutation, governance, evidence gate | done, <!--sg:SG-00.artifact.tests_fast-->743<!--/sg--> tests, <!--sg:SG-00.artifact.fast_lane_seconds-->80.2<!--/sg--> s |
