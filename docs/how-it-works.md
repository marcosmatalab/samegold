...
- clustering by (month, sku) cut the share of the table a sku predicate has to read by
  **<!--sg:SG-09.artifact.share_read_reduction_pct-->78.23<!--/sg-->%**, **and by nothing at all**
...
| lane | status |
|---|---|
| fast lane: generator, reference, digests, invariants, mutation, governance, evidence gate | done, <!--sg:SG-00.artifact.tests_fast-->788<!--/sg--> tests, <!--sg:SG-00.artifact.fast_lane_seconds-->47.2<!--/sg--> s |
