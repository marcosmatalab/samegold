...
| lane | status |
|---|---|
| fast lane: generator, reference, digests, invariants, mutation, governance, evidence gate | done, <!--sg:SG-00.artifact.tests_fast-->788<!--/sg--> tests, <!--sg:SG-00.artifact.fast_lane_seconds-->79.3<!--/sg--> s |
