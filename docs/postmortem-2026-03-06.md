...
**Impact** the signed January close was overstated by <!--sg:SG-04.artifact.worst_delta_eur-->33 717,17<!--/sg--> EUR, <!--sg:SG-04.artifact.worst_move_pct-->5.8767<!--/sg-->% of net revenue
**Data loss** none
**Status** closed; two actions done, one open

## What happened

January was closed on 5 February with net revenue of <!--sg:SG-04.artifact.worst_first_close_eur-->573 746,43<!--/sg--> EUR. Between that close and
...
At the February close the pipeline recorded a new version of January at <!--sg:SG-04.artifact.worst_final_eur-->540 029,26<!--/sg--> EUR, with
...
| when | what |
|---|---|
| 5 Feb 23:59 | January closed, version 0, <!--sg:SG-04.artifact.worst_first_close_eur-->573 746,43<!--/sg--> EUR |
| 6 Feb - 4 Mar | late returns and amendments arrive for January sales |
| 5 Mar 23:59 | February close runs; a new January version is recorded, <!--sg:SG-04.artifact.worst_final_eur-->540 029,26<!--/sg--> EUR |
...
- **The size of a restatement is not bounded anywhere.** A <!--sg:SG-04.artifact.worst_move_pct-->5.8767<!--/sg-->% move is normal for this
