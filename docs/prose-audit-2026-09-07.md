...
**The adversarial sweep.** Five review passes read every document under a different lens - claims of
...
them against the repository with real commands. Every candidate then went to a separate review
pass whose instruction was to REFUTE it, defaulting to "not false" and looking specifically for a
