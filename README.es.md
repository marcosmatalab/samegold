...
|---|---|---|---|
| ✅ | Vía rápida, sin JVM y sin credenciales | <!--sg:SG-00.artifact.tests_passed-->758<!--/sg--> tests superados en <!--sg:SG-00.artifact.fast_lane_seconds-->79.3<!--/sg--> s | `SG-00` |
...
| 🔗 | Registros de evidencia verificados en la cadena de hashes | <!--sg:SG-06.artifact.records_verified-->18<!--/sg--> | `SG-06` |
...
| 📉 | Reducción de la parte de la tabla que lee una consulta por sku, gracias al clustering | <!--sg:SG-09.artifact.share_read_reduction_pct-->78.24<!--/sg-->% | `SG-09` |
...
| 🧱 | Arnés de verificación frente a código de plataforma, en líneas | <!--sg:SG-00.artifact.harness_lines-->24 610<!--/sg--> frente a <!--sg:SG-00.artifact.platform_lines-->7 567<!--/sg--> | `SG-00` |
