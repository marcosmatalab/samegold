...
|---|---|---|---|
| ✅ | Vía rápida, sin JVM y sin credenciales | <!--sg:SG-00.artifact.tests_passed-->757<!--/sg--> tests superados en <!--sg:SG-00.artifact.fast_lane_seconds-->47.2<!--/sg--> s | `SG-00` |
...
| 🔗 | Registros de evidencia verificados en la cadena de hashes | <!--sg:SG-06.artifact.records_verified-->8<!--/sg--> | `SG-06` |
...
| 📉 | Reducción de la parte de la tabla que lee una consulta por sku, gracias al clustering | <!--sg:SG-09.artifact.share_read_reduction_pct-->78.23<!--/sg-->% | `SG-09` |
